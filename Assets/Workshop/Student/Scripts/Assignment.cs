...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        {
            r = UnityEngine.Random.Range(0, as01_items.Length);
            Instantiate(as01_items[r], new Vector2(0, 0), transform.rotation);
            Debug.Log($"Got item: {as01_items[r].name}");
        }
        ...
        public IEnumerator AS12_CountTime()
        {
            ...
            {
                Debug.Log($"Remaining Time:{as12_countTime} seconds");
        ...
        public void AS13_SumOfNumbersInRow()
        {
            ...
            Debug.Log($"ผลรวมของ Row :{as13_row} คือ {sum}");
        }
        ...
        public void AS14_SumOfNumbersInColumn()
        {
            ...
            Debug.Log($"ผลรวมของ Column :{as14_column} คือ {sum}");
        }
